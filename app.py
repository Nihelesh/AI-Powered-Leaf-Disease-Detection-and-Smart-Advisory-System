...
CLASS_NAMES = [
    ...
    'Corn_(maize)__Northern_Leaf_Blight','Corn(maize)___healthy',
    ...
    'Tomato__Bacterial_spot','Tomato_Early_blight','Tomato__Leaf_Mold',
...
def parse_prediction(predicted_class):
    ...
    if '_' in predicted_class:
        plant, disease = predicted_class.split('_')
